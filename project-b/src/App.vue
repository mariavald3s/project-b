...
<template>
  <header>
      <nav class="p-6 bg-[#0B0C10] text-[#C4C4C4] font-[32px] font-[600] flex justify-between fixed w-screen z-20">
        ...
        <RouterLink to="/about-us" class="px-2 hover:text-[#e4e4e4]">About Us</RouterLink>
        <RouterLink to="/contact-us" class="px-2 hover:text-[#e4e4e4]">Contact Us</RouterLink>
        </div>
        <div class="flex">
          <button class="snipcart-checkout px-2 justify-self-end font-[600] ">Cart</button>
        <!-- <RouterLink to="/cart" class="px-2 justify-self-end snipscart-checkout">Cart</RouterLink> -->
